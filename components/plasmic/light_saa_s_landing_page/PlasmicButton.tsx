...
import sty from "./PlasmicButton.module.css"; // plasmic-import: r9032rPlF7c2/css
    ...
    >
      ...
      <Stack__
        ...
        className={classNames(projectcss.all, sty.freeBox__lfIwC, {
          [sty.freeBoxcolor_neutral__lfIwCbbarj]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__lfIwCixu23]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__lfIwCUyx31]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__lfIwCj64F1]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__lfIwCq4X7W]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__lfIwCpjY2C]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__lfIwC5GWu]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__lfIwC5GWuC3Nhf]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__s9TWq, {
            [sty.freeBoxcolor_neutral__s9TWqbbarj]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__s9TWQaXnt]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__s9TWqUyx31]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__s9TWqq4X7W]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__s9TWQpjY2C]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__s9TWq5GWu]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__s9TWq13NplBbarj]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__yy4PH)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__mm6Mb, {
            [sty.freeBoxiconEnd__mm6MbRv1Xo]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__mm6MbUyx31]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__mm6MbQ4X7W]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__mm6MbpjY2C]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg___23W54)}
                role={"img"}
              />
            ),
