...
import Logo from "../../Logo"; // plasmic-import: bIzb6tergt5E/component
...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: zbmVtYiGCSxi/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__feFxv)}
      >
        <Logo
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__cwCp)}
        >
          <PlasmicLink__
            className={classNames(
              projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__hqvvm)}
        >
          <PlasmicLink__
            className={classNames(
              projectcss.all,
