...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: HqfI1TgJrnaE/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__xmRC)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__s88Oj)}
              role={"img"}
            />
          ),
